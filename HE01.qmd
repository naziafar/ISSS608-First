...
subtitle: "<strong style='font-size:1.6rem;'>A Layered Grammar of Graphics (ggplot2 methods)</strong>"
...
ggplot2 is an implementation of Leland Wilkinson’s Grammar of Graphics. ![](image1.jpg) There are seven grammars of ggplot2, as seen in the image and described below:
...
The + operator is used to add a geom to the plot. The image below shows examples of some geometric objects. ![](image2.jpg) For the complete list, please refer to [here](https://ggplot2.tidyverse.org/reference/#section-layer-geoms) \## 7.1 Geometric Objects: geom_bar The code chunk below plots a bar chart by using geom_bar()
