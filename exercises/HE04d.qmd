...
In this section, COVID-19_DKI_Jakarta will be used. The data was downloaded from [Open Data Covid-19 Provinsi DKI Jakarta portal](https://riwayat-file-covid-19-dki-jakarta-jakartagis.hub.arcgis.com/). For this exercise, we are going to compare the cumulative COVID-19 cases and death by sub-district (i.e. kelurahan) as of 31st July 2021, DKI Jakarta.
...
In this section, we will gain hands-on experience on building funnel plots step-by-step using ggplot2. It aims to enhance our working experience of ggplot2 to customise specialised data visualisation like funnel plot.
