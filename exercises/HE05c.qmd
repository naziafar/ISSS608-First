...
## 2.2 Importing and preparing the dataset
...
There are several R packages and functions that can be used to draw static heatmaps. They are:
...
# 4. Creating Interactive Heatmaps
...
Before we get started, make sure to review the [Introduction to Heatmaply](https://cran.r-project.org/web/packages/heatmaply/vignettes/heatmaply.html) to have an overall understanding of the features and functions of Heatmaply package. Make sure to also have the [user manual](https://cran.r-project.org/web/packages/heatmaply/heatmaply.pdf) of the package handy for reference purposes.

In this section, we will gain hands-on experience using **heatmaply** to design an interactive cluster heatmap. We will still use the wh_matrix as the input data.
