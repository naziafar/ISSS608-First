...
subtitle: "<strong style='font-size:1.6rem;'>Programming Animated Statistical Graphics with R</strong>"
...
The *Data* worksheet from *GlobalPopulation* Excel workbook will be used for this exercise.

We write the below code chunk to import the Data worksheet from GlobalPopulation Excel workbook by using appropriate R package from tidyverse family.

```{r}
col <- c("Country", "Continent")
globalPop <- read_xls("data/data/GlobalPopulation.xls",
                      sheet="Data") %>%
